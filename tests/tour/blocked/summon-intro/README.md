...
**syntax unblocked by dsc#188 (0.52.0):** summon return types are colon-free,
like `fn`. The draft already uses this spelling. Sibling-module delivery above
still blocks publication; keep the lesson out of the manifest until it is fixed.
...
Historical validation with released dsc 0.51.1 + deka 0.50.0: the exact draft is rejected at
